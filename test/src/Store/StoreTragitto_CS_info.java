		...
		if(rs != null){
			try {
				while(rs.next()){
					...
					Tragitto_CS_info_list.add(new Tragitto_CS_info(nome,citta,provincia,marca,modello,tempo_prelievo,tempo_consegna,tempo_prelievo_prenotazione,tempo_consegna_prenotazione,km,pagato,id,-1,null));
				}
		...
		if(rs != null){
			try {
				while(rs.next()){
					...
					Tragitto_CS_info_list.add(new Tragitto_CS_info(nome,citta,provincia,marca,modello,tempo_prelievo,tempo_consegna,tempo_prelievo_prenotazione,tempo_consegna_prenotazione,km,pagato,id_tessera,id,null));
				}
			}catch (SQLException e){
			}
		}
